...
export async function listConjuntos(req: FastifyRequest, reply: FastifyReply) {
...
export async function getConjuntoById(req: FastifyRequest, reply: FastifyReply) {
...
export async function updateConjunto(req: FastifyRequest, reply: FastifyReply) {
  const params = conjuntoParamsSchema.safeParse(req.params);
  if (!params.success) return handleZodError(reply, params.error);
...
export async function deactivateConjunto(req: FastifyRequest, reply: FastifyReply) {
  const params = conjuntoParamsSchema.safeParse(req.params);
  if (!params.success) return handleZodError(reply, params.error);
...
export async function deleteConjunto(req: FastifyRequest, reply: FastifyReply) {
  const params = conjuntoParamsSchema.safeParse(req.params);
  if (!params.success) return handleZodError(reply, params.error);
