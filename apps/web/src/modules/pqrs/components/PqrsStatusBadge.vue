<template>
  <span :class="['inline-flex items-center gap-1 rounded-full px-2.5 py-0.5 text-xs font-medium ring-1 ring-inset', estadoBadgeClass(estado)]">
...
const label = computed(() => ESTADOS_PQRS.find((e) => e.value === props.estado)?.label ?? props.estado)
